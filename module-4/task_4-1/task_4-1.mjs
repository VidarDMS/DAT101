...
class TBankAccount{
    ...
    deposit(aAmount, aCurrencyType = CurrencyTypes.NOK){
        ...
        printOut("Deposit of "+ aAmount + " " + name + ", new balance is "+ this.#balance);
    }
    withdraw(aAmount, aCurrencyType = CurrencyTypes.NOK){. //Her kan det være jeg mangler noe feil
        switch(this.#type){
...
myAccount.withdraw(150, CurrencyTypes.SEK);
printOut(newLine);
